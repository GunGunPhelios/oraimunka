#Diak osztaly= attr. nev, jegyek, metod.: uj_jegy(jegy), atlag()
#Jegyzet osztaly: attr.: diakok.metod.:uj diak(diak), atlagok_osszege(), osszes_diak_atlaga()
...
print(f"Atlagok osszege: {jegyzet.atlagok_osszege()}")
